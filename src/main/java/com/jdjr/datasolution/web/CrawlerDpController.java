...
import com.jdjr.datasolution.util.ConnectAdslNet;
import com.jdjr.datasolution.util.GetHtmlUtil;
...
public class CrawlerDpController {
    ...
    public CrawlerDpController(File propertiyFile) {
    ...
    public static void main(String args[]) throws Exception {
        try {
            ...
            CrawlerDpController infoExtra = new CrawlerDpController(new File("input/settings.properties"));
            ...
            LOGGER.warn("爬虫结束****");
            FileUtils.write(new File("log/crawleredCity.log"),"");
        } catch (Exception e) {
            LOGGER.error("抓取失败");
        }
    }
